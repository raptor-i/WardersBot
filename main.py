...
async def on_message(message):
  ...
  if message.content.startswith("!evlen"):
    ...
    await message.channel.send("%s 'in Evleneceği Tarih	: **%s.%s.%s**  \U0001F935\U0001F470"%(user,result[2],result[1],result[0]))
